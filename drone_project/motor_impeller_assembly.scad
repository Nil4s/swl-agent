...
// Export Mode
EXPORT_MODE = "full_assembly";  // Options: "full_assembly", "impeller_only", "motor_only"
...
BLADED_DIAMETER = 90;             // mm (optimize: 80-100)
BLADED_HUB_DIAMETER = 15;         // mm (optimize: 12-20)
BLADED_BLADE_COUNT = 3;           // (optimize: 2, 3, 4)
BLADED_ROOT_CHORD = 35;           // mm (optimize: 30-40)
BLADED_TIP_CHORD_RATIO = 0.7;    // (optimize: 0.6-0.8)
BLADED_BLADE_THICKNESS = 2;       // mm (optimize: 1.5-3)
BLADED_BLADE_TWIST = -25;         // degrees total twist (optimize: -30 to -15)
BLADED_ATTACK_ANGLE = -5;         // degrees at root (optimize: -8 to -2)
